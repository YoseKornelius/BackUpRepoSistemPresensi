...
import com.androidfaceauthentication.base.CameraSource;
import com.androidfaceauthentication.base.CameraSource.SizePair;
...
public class PreferenceUtils {
    ...
    private static final String STRING_USER_NAME = "STRING_USER_NAME";
    private static final String STRING_FACE_EMBEDING = "STRING_FACE_EMBEDING";

    static void saveString(Context context, String prefKeyId, @Nullable String value) {
    ...
    public static FaceDetectorOptions getFaceDetectorOptions(Context context) {
        ...
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        boolean enableFaceTracking = sharedPreferences.getBoolean(
    ...
    public static void saveFaceEmbeddings(Context context, List<String> embedingFloatList) {
        Gson gson = new Gson();
        String embedingString = gson.toJson(embedingFloatList);
        saveString(context, STRING_FACE_EMBEDING, embedingString);
    }

    public static float[] getFaceEmbeddings(Context context) {
        Type type = new TypeToken<float[]>() {
        }.getType();
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        String faceEmbedString = sharedPreferences.getString(STRING_FACE_EMBEDING, "");
        Gson gson = new Gson();
        float[] embeddingFloatArr = gson.fromJson(faceEmbedString, type);
