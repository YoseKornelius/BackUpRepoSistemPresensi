...
import com.androidfaceauthentication.base.GraphicOverlay.Graphic;
...
public class FaceGraphic extends Graphic {
    ...
    FaceGraphic(GraphicOverlay overlay, Face face, Recognition recognition) {
        this(overlay, face);
    ...
    public void draw(Canvas canvas) {
        ...
        yLabelOffset = yLabelOffset - 4 * lineHeight;

        textWidth = Math.max(textWidth, idPaints[colorID]
                .measureText(String.format(Locale.US, "EulerX: %.2f",
                        face.getHeadEulerAngleX())));
        textWidth = Math.max(textWidth, idPaints[colorID]
                .measureText(String.format(Locale.US, "EulerY: %.2f", face.getHeadEulerAngleY())));
        textWidth = Math.max(textWidth, idPaints[colorID]
                .measureText(String.format(Locale.US, "EulerZ: %.2f",
                        face.getHeadEulerAngleZ())));
        textWidth = Math.max(textWidth, idPaints[colorID]
                .measureText(String.format(Locale.US, "Title : %s",
                        "123456789qwertyuiop")));
        ...
        canvas.drawRect(
                ...
                top + yLabelOffset,
                left + textWidth + (3 * BOX_STROKE_WIDTH),
                top,
                labelPaints[colorID]);
        ...
        //draw recognition
        if (recognition != null) {
            canvas.drawText("Title : " + recognition.getTitle()
//                            ", Dist : " + recognition.getDistance(),
